"""Build the 437 priority-project rows from the Indonesia CIPP 2023 PDF."""
...
try:
    from jetp._idn_priority_projects import (
        number as _number,
    )
    from jetp._idn_priority_projects import (
        ordinal as _ordinal,
    ...
    from jetp._idn_priority_projects import write_csv
except ModuleNotFoundError:  # Support direct execution from scripts/jetp.
    from _idn_priority_projects import (
        number as _number,
    )
    from _idn_priority_projects import (
        ordinal as _ordinal,
    ...
    from _idn_priority_projects import (  # type: ignore[no-redef]
        write_csv,
    )
