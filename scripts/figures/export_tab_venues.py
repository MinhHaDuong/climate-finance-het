...
def main():
    ...
    caption = (
        ...
        "assigned to a pole only when that pole outnumbers the other by more "
        "than a factor of 1.42 on Laplace-smoothed counts (an odds ratio "
        "whose base-2 logarithm exceeds 0.5); "
