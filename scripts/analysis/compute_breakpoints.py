...
Usage:
    uv run python scripts/analysis/compute_breakpoints.py --output data/derived/tables/tab_breakpoints.csv
    uv run python scripts/analysis/compute_breakpoints.py --output data/derived/tables/tab_breakpoint_robustness.csv --robustness
    uv run python scripts/analysis/compute_breakpoints.py --output data/derived/tables/tab_breakpoints_core.csv --core-only
    uv run python scripts/analysis/compute_breakpoints.py --output data/derived/tables/tab_k_sensitivity.csv --k-sensitivity
"""
