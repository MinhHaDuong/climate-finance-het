...
Produces:
- deliverables/_shared/tables/tab_citation_coverage.md: period coverage + core coverage
...
OUTPUT_PATH = os.path.join(BASE_DIR, "deliverables", "_shared", "tables", "tab_citation_coverage.md")
