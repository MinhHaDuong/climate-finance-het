...
**Tier 1 — Core terms** (no post-filter): Unambiguous climate finance terminology in eight languages. English (`"climate finance"`, `"carbon finance"`), French (`"finance climat"`, `"finance climatique"`), German (`"Klimafinanzierung"`), Spanish (`"financiamiento climático"`, `"financiación climática"`), Portuguese (`"financiamento climático"`), Arabic (`"تمويل المناخ"`), Chinese (`"气候金融"`, `"气候融资"`), Japanese (`"気候金融"`, `"グリーンファイナンス"`). Also includes institution names: `"green climate fund"`, `"adaptation fund"`.
