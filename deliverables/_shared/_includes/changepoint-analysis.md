...
<!-- PROVENANCE UNRESOLVED (0244): the annual-silhouette series, BIC values (per number of breaks) and
     t-statistics come from the log output of `scripts/analysis/compute_clustering_comparison.py`; no committed
...
**Script:** `scripts/analysis/compute_clustering_comparison.py` (annual silhouette), BIC piecewise-constant model
