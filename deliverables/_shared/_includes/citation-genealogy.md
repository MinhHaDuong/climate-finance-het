...
**Scripts:** `scripts/analysis/analyze_genealogy.py` (model), `scripts/figures/plot_genealogy.py` (static figure), `scripts/figures/plot_genealogy_html.py` (interactive)
