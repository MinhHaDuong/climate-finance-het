...
Embeddings are needed for the semantic-distance diagnostic (flag 5 in §3) and for the alluvial and bimodality analyses. See the Corpus Contents section for UMAP visualizations of the resulting semantic space.
